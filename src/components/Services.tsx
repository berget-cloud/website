...
const serviceList: ServiceProps[] = [
  {
    ...
    swedish: true,
    launch: true,
    icon: <img src={mistral} className="w-24" alt="Mistral logo" />,
  },
  {
  ...
  },
  {
    ...
    swedish: true,
    launch: false,
    icon: <img src={aiSweden} className="w-24" alt="AI Sweden logo" />,
  },
  {
    title: 'CodeLlama 70B',
    description: 'Bra på att programmera. Kommer under våren.',
    launch: false,
    icon: <img src={llama} className="w-24" alt="Llama logo" />,
  },
  {
    title: 'Valfri modell',
    description: 'Välj och vraka hos Huggingface. Kommer i höst.',
    launch: false,
    icon: <img src={huggingface} className="w-24" alt="Huggingface logo" />,
  },
]
